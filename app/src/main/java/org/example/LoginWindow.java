...
public class LoginWindow {
        ...
        public Scene getLoginScene(Stage stage, SessionHandler SH) {
                ...
                Text question = new Text("Don't have an account?");
                question.setFont(new Font("Arial", 14));
                question.setFill(Color.valueOf("rgb(71,71,81)"));

                Button createLink = new Button("Create one");
                createLink.setStyle(
                ...
                createLink.setOnMouseEntered(e -> createLink.setStyle(
                ...
                createLink.setOnMouseExited(e -> createLink.setStyle(
                                "-fx-background-color: rgba(71, 124, 234, 0); -fx-text-fill: rgb(71,124,234); -fx-background-radius: 8; -fx-font-size: 14px; -fx-font-family: Arial;"));

                HBox createPrompt = new HBox(1, question, createLink);
                createPrompt.setAlignment(Pos.CENTER);

                // Arrange the text fields and button vertically
                VBox loginForm = new VBox(15, subtitle, usernameField, passwordField, loginButton, createPrompt);
                loginForm.setAlignment(Pos.CENTER);

                loginForm.prefWidthProperty().bind(stage.widthProperty().multiply(0.3));
